                ...
                return (
                  <>
                    <span className="text-xs text-muted-foreground flex items-center gap-1.5">
                      {jiraCount > 0 && <span className="flex items-center gap-0.5"><svg className="w-3 h-3 text-muted-foreground" viewBox="0 0 24 24" fill="currentColor"><path d="M11.571 11.513H0a5.218 5.218 0 0 0 5.232 5.215h2.13v2.057A5.215 5.215 0 0 0 12.575 24V12.518a1.005 1.005 0 0 0-1.005-1.005zm5.723-5.756H5.736a5.215 5.215 0 0 0 5.215 5.214h2.129v2.058a5.218 5.218 0 0 0 5.215 5.214V6.758a1.001 1.001 0 0 0-1.001-1.001z"/></svg>{jiraCount}</span>}
